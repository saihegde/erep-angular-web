materialAdmin
    ...
    .controller('materialadminCtrl', function($timeout, $state, growlService){
        //Welcome Message
        growlService.growl('Welcome back Sai!', 'inverse')
    ...
    .controller('headerCtrl', function($timeout, messageService){
        ...
        this.openSearch = function(){
            ...
            //growlService.growl('Welcome back Sai Hegde', 'inverse');
        }
    ...
    .controller('profileCtrl', function(growlService){
        ...
        this.fullName = "Sai Hegde";
        this.gender = "male";
        this.birthDay = "21/10/1983";
        this.martialStatus = "Single";
        this.mobileNumber = "00971123456789";
        this.emailAddress = "shegde@utah.gov";
        this.twitter = "@saihegde";
        this.twitterUrl = "twitter.com/saihegde";
        this.skype = "shegde";
        this.addressSuite = "140 E Broadway";
        this.addressCity = "Salt Lake City, UT";
